...
/// @note   This structure is used only with TIM1 and TIM16 and TIM17.
////////////////////////////////////////////////////////////////////////////////
...
/**
  * @brief break input sel
  */
#define TIM1_BKIN_CSS                      (0x01U << TIM_BKINF_BKIN_SEL_Pos)     /*!< TIM1 break input sel CSS */
#define TIM1_BKIN_PA6                      (0x02U << TIM_BKINF_BKIN_SEL_Pos)     /*!< TIM1 break input sel PA6 */
#define TIM1_BKIN_PB12                     (0x04U << TIM_BKINF_BKIN_SEL_Pos)     /*!< TIM1 break input sel PB12 */
#define TIM1_BKIN_PA13                     (0x08U << TIM_BKINF_BKIN_SEL_Pos)     /*!< TIM1 break input sel PA13 */
#define TIM1_BKIN_PA4                      (0x10U << TIM_BKINF_BKIN_SEL_Pos)     /*!< TIM1 break input sel PA4 */
#define TIM1_BKIN_PD6                      (0x20U << TIM_BKINF_BKIN_SEL_Pos)     /*!< TIM1 break input sel PD6 */
#define TIM1_BKIN_CPT                      (0x40U << TIM_BKINF_BKIN_SEL_Pos)     /*!< TIM1 break input sel CPT */

#define TIM16_BKIN_CSS                 	   (0x01U << TIM_BKINF_BKIN_SEL_Pos)     /*!< TIM16 break input sel CSS  */
#define TIM16_BKIN_PB5                     (0x02U << TIM_BKINF_BKIN_SEL_Pos)     /*!< TIM16 break input sel PB5  */

#define TIM17_BKIN_CSS                     (0x01U << TIM_BKINF_BKIN_SEL_Pos)     /*!< TIM17 break input sel CSS  */
#define TIM17_BKIN_PA10                    (0x02U << TIM_BKINF_BKIN_SEL_Pos)     /*!< TIM17 break input sel PA10 */
#define TIM17_BKIN_PB4                     (0x04U << TIM_BKINF_BKIN_SEL_Pos)     /*!< TIM17 break input sel PB4 */
...
void TIM_BreakInputFilterConfig(TIM_TypeDef *tim, u32 source, u32 filter);
