...
// MM32 Library version is V0.3.0

#define __MM32_LIB_VERSION_MAIN         (0x00U)                                 //!< [31:24] main version 
#define __MM32_LIB_VERSION_SUB1         (0x03U)                                 //!< [23:16] sub1 version
...
// MM32 Library release date is 2021-10-13
...
#define __MM32_LIB_RELESE_DAY           (0x13U)                                 //!< [7:0]   release day
