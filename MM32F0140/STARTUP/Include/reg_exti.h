...
#define EXTI_CFGR_MIPI_RX_DMA_Pos   (31)
#define EXTI_CFGR_MIPI_RX_DMA       (0x01U << EXTI_CFGR_MIPI_RX_DMA_Pos)    ///< MIPI RX DMA Remap
...
#define EXTI_PADHYS_I2C1_MODE_Pos    (16)
#define EXTI_PADHYS_I2C1_MODE        (0x01U << EXTI_PADHYS_I2C1_MODE_Pos)     ///< I2C1 select Push-pull mode
#define EXTI_PADHYS_I2C2_MODE_Pos    (17)
#define EXTI_PADHYS_I2C2_MODE        (0x01U << EXTI_PADHYS_I2C2_MODE_Pos)     ///< I2C2 select Push-pull mode
////////////////////////////////////////////////////////////////////////////////
