...
typedef struct {
    ...
    __IO u32 OR;                                                                ///< TIM Input Option Register,                     offset: 0x50
    ...
    __IO u32 BKINF;                                                             ///< TIM Brake input filter register,               offset: 0x74
} TIM_TypeDef;
...
#define TIM_CCER_CC4NP                  (0x01U << TIM_CCER_CC4NP_Pos)           ///< Capture/Compare 5 Complementary output Polarity
...
#define  TIM_OR_ETR_RMP_Msk           (0x03U << TIM_OR_ETR_RMP_Pos)          ///< ETR multiplex
#define  TIM_OR_TI4_RMP_Pos           (6)
#define  TIM_OR_TI4_RMP_Msk           (0x03U << TIM_OR_TI4_RMP_Pos)          ///< TI4 multiplex
...
#define TIM_BKINF_BKIN_SEL_Msk          (0x0FFFU << TIM_BKINF_BKIN_SEL_Pos)   /*!< break input sel */
