...
typedef struct {
    ...
    __IO u32 RESERVED0x24;                                                      ///< Reserved                                       offset: 0x20
    ...
    __IO u32 CFGR2;                                                             ///< Configuration Register 2                       offset: 0x2C
    ...
    __IO u32 RESERVED[12];                                                      ///< Reserved                                       offset: 0x54
...
#define RCC_APB1RSTR_MIPI_Pos           (13)
#define RCC_APB1RSTR_MIPI               (0x01U << RCC_APB1RSTR_MIPI_Pos)        ///< MIPI reset
...
#define RCC_APB1ENR_MIPI_Pos            (13)
#define RCC_APB1ENR_MIPI                (0x01U << RCC_APB1ENR_MIPI_Pos)         ///< MIPI enable
